...
public class RoomsGenerator : MonoBehaviour
{
		...
		public float X = -20, Y = -20, Width = 40, Height = 40;
		public float DoorSize = 4f;
		...
		void Awake ()
		{
				...
				room.Split (Iteration, walls, WallSize);
...
{	
		...
		public void Split (int iteration, ArrayList wallCollector, float wallSize)
		{
				bool splitBias = Random.Range (0f, 1f) > 0.5f;
				Split (iteration, wallCollector, wallSize, splitBias);
		}
	
		public void Split (int iteration, ArrayList wallCollector, float wallSize, bool splitBias)
		{
				if (iteration == -1)
						return;
				...
				child1.Split (iteration, wallCollector, wallSize, splitBias);
				child2.Split (iteration, wallCollector, wallSize, splitBias);
